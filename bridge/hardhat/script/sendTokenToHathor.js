...
async function main() {
    ...
    const result = await token.methods.approve(BridgeProxy.address, '1028000000000000000').send({from: deployer, gasLimit: 3000000});
    ...
    const receipt = await bridge.methods
        ...
        '1028000000000000000').send({ from: deployer, gasLimit: 3000000 });
